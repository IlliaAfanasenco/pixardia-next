...
export default function Header() {
    return (
        <header
            className="sticky top-0 z-[60] w-full border-b border-black/[0.04] bg-white/95"
            data-site-header=""
        >
            <div className="mx-auto flex w-full max-w-[var(--container)] items-center justify-between gap-4 px-5 py-5 sm:px-8 lg:gap-6 lg:px-10">
                <Link
